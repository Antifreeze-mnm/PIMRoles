...
$ActivateButton.Add_Click({
        ...
        foreach ($SelectedRole in $SelectedRoles) {
            ...
            Write-host "$($SelectedRole.RoleDisplayName) has been activated until $($Schedule.Expiration.Duration)!" -ForegroundColor Green
        }
    ...
    ($_.SelectedRoles | ForEach-Object { $_.RoleDisplayName }) -join "," -eq ($newEntry.SelectedRoles | ForEach-Object { $_.RoleDisplayName }) -join "," | Out-Null
        }
