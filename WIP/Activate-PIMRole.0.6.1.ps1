...
if ($null -eq $RoleListBox) { Write-Host "RoleListBox not found" }
if ($null -eq $SelectedRolesTextBlock) { Write-Host "SelectedRolesTextBlock not found" }
if ($null -eq $ReasonTextBox) { Write-Host "ReasonTextBox not found" }
if ($null -eq $DurationTextBox) { Write-Host "DurationTextBox not found" }
if ($null -eq $HistoryComboBox) { Write-Host "HistoryComboBox not found" }
if ($null -eq $LogTextBox) { Write-Host "LogTextBox not found" }
if ($null -eq $ActivateImage) { Write-Host "ActivateImage not found" }
if ($null -eq $ClearImage) { Write-Host "ClearImage not found" }
function Write-Log {
    param (
        [string]$message,
        [string]$color = "Black"
