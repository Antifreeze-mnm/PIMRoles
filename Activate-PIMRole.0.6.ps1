...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        ...
        Title="PIM Role Activation 0.5" Height="570" Width="600">
    <Window.Resources>
    ...
    <Grid>
        ...
        <Grid Grid.Row="1" Grid.ColumnSpan="2">
            ...
            <StackPanel Orientation="Horizontal" HorizontalAlignment="Left" VerticalAlignment="Bottom" Margin="10,0,10,10">
                <Image Name="ActivateImage" Width="45" Height="45"/>
                <TextBlock Text="Activate" VerticalAlignment="Center" Margin="5,0,0,0" FontWeight="Bold" Foreground="Navy" FontSize="18"/>
            </StackPanel>
            ...
            <StackPanel Orientation="Horizontal" HorizontalAlignment="Right" VerticalAlignment="Bottom" Margin="10,0,10,10">
                <TextBlock Text="Reset" VerticalAlignment="Center" Margin="0,0,5,0" FontWeight="Bold" Foreground="Navy" FontSize="18"/>
                <Image Name="ResetImage" Width="45" Height="45"/>
            </StackPanel>
        </Grid>
    </Grid>
</Window>
...
function Convert-Base64ToImage {
    ...
    try {
        ...
        Write-host "Error converting Base64 string to image: $_"
        return $null
    }
}

#Region ActivateButtonImage
# Base64 string for the image
$ActivateBase64String = ""
#endregion

#Region ResetButtonImage
# Base64 string for the image
$ResetBase64String = ""
#endregion

# Convert Base64 string to image
$activateImage64 = Convert-Base64ToImage -base64String $ActivateBase64String
$resetImage64 = Convert-Base64ToImage -base64String $ResetBase64String
$ActivateImage.Source = $ActivateImage64
$ResetImage.Source = $ResetImage64
...
$ResetImage.MouseLeftButtonUp.Add({
        $RoleListBox.SelectedItems.Clear()
